...
class TransaksiPelanggan extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('konten/pelanggan/transaksi/index.php', $data);
    }
    ...
    public function add($id)
    {
        ...
        return view('konten/pelanggan/transaksi/add', $data);
    }public function store()
    {
        ...
        // Redirect ke halaman transaksi pelanggan
        return redirect()->to('/pelanggan/transaksi')->with('success', 'Transaksi berhasil disimpan.');
    }
